...
public class UpdateTicketGate {

    private final TicketRepository repository;


    public UpdateTicketGate(TicketRepository repository) {
        this.repository = repository;
    }

    public void execute(String ticketId, int gate){
        ...
        if (ticketOptional.isEmpty()) {
            ...
            ticket.updateticketGate(new TicketGate(gate));
